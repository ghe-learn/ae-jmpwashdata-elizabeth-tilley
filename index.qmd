...
For this analysis we will use the **jmpwashdata** R Package. The package contains all data compiled by the [WHO/UNICEF Joint Monitoring Programme (JMP).](http://washdata.org)
