...
For this analysis we will use the **jmpwashdata** R Package by @jmpwashdata. The package contains all data compiled by the [WHO/UNICEF Joint Monitoring Programme (JMP).](http://washdata.org)
...
![This is hanging toilet (unacceptable)](img/26473744850_32578ea50b_w.jpg)
...
#| fig-cap: Access to santation (urban) in 2020 by income classifications.
